...
export declare function startGame(defaultScene: State, pixelated?: boolean): void;
...
export declare function lerp(start_value: number, end_value: number, time: number): number;
